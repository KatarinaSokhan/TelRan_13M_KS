...
public class Bank {
    ...
    public void getCountClientsPerSex() {
        ...
        for (BankAccount account : this.getExistingAccounts()) {
            if(account.getClient().getSex().equals(Sex.FEMALE)) {
                numberOfFemales++;
            }

            if (account.getClient().getSex().equals(Sex.MALE)) {
                numberOfMales++;
            }
        }

        System.out.println("Females: " + numberOfFemales + ", Males: " + numberOfMales);
    }
